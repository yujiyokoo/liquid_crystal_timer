...
// This is yet another hack of the liquid crystal example
...
extern const uint8_t liquid_crystal_rb_timer[];
...
void setup(){
	...
	char* class_name = "LiquidCrystalRbTimer";
	...
	delay(100);
	mrb_load_irep(mrb, liquid_crystal_rb_timer);
	if (mrb->exc){
		Serial.print(class_name);
